...
public class AnlagenBestandId implements Serializable {
    private int gemeindeSchluessel;
    private String monat;

    public AnlagenBestandId() {
    }

    public AnlagenBestandId(int gemeindeSchluessel, String monat) {
    ...
    public boolean equals(Object o) {
        ...
        AnlagenBestandId that = (AnlagenBestandId) o;
